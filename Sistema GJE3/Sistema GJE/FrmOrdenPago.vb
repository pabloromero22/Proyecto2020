...
Public Class FrmOrdenPago
    ...
    Private Sub FrmOrdenPago_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        cn.ConnectionString = (constConexion)
        cm.CommandType = CommandType.Text
        cm.CommandText = "SELECT MAX(id_ordenpago) as max FROM OrdenPago"
        cm.Connection = cn
        cn.Open()
        dr = cm.ExecuteReader()
        dr.Read()
